...
function setActiveButton(activeId) {
    [homeBtn, aboutBtn, aboutUsBtn].forEach(btn => btn.classList.remove('active'));
...
function initNotes() {
    ...
    function addNote(text, reminderTimestamp) {
        ...
        if (reminderTimestamp) {
            socket.emit('newReminder', { id: newNote.id, text: text, timestamp: reminderTimestamp });
        } else {
...
async function subscribeToPush() {
    ...
    try {
        ...
        const subscription = await registration.pushManager.subscribe({
            ...
            applicationServerKey: urlBase64ToUint8Array('BKJmhQeqS04WzlWIkFd9Ba4s-GDxrVVeuHmHInzCUzYHrRRktAFp9ygIaX5aSX4NW-6Cn2ViGB8NrmrS6jfOB-c'),
        });
